...
## Colony monitoring based on difference in air composition


### General idea

Alive isopods excrete some amount of VOC - volatile organic compounds.
Dead isopods excrete different VOCs.

If we were able to analyse the air in the enclosure and detect changes in the quantity of different VOCs, we could determine the health of the colony.
